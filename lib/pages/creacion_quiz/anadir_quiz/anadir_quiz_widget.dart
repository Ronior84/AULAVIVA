...
import 'anadir_quiz_model.dart';
export 'anadir_quiz_model.dart';

class AnadirQuizWidget extends StatefulWidget {
  const AnadirQuizWidget({
    super.key,
    this.quizSet,
  });
  ...
  @override
  State<AnadirQuizWidget> createState() => _AnadirQuizWidgetState();
}

class _AnadirQuizWidgetState extends State<AnadirQuizWidget> {
  late AnadirQuizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnadirQuizModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0x2B6F61EF),
                    ...
                    onPressed: () async {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          ...
                          backgroundColor: Color(0x2439D2C0),
                        ),
                      );
