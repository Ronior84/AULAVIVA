...
import 'schema/cont_record.dart';
...
export 'schema/cont_record.dart';
...
Future<int> queryContenidosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
/// Functions to query ContRecords (as a Stream and as a Future).
Future<int> queryContRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ContRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ContRecord>> queryContRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ContRecord.collection,
      ContRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ContRecord>> queryContRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
