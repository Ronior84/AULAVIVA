...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/createQuizQuest',
          builder: (context, params) => CreateQuizQuestWidget(),
        ),
        FFRoute(
          name: 'AnadirQuiz',
          path: '/anadirQuiz',
          builder: (context, params) => AnadirQuizWidget(
        ...
        FFRoute(
          ...
          path: '/contenido',
          requireAuth: true,
          builder: (context, params) => ContenidoWidget(),
        ),
        FFRoute(
          name: 'contExplicado',
          path: '/contExplicado',
          builder: (context, params) => ContExplicadoWidget(
            contExplicado: params.getParam(
              'contExplicado',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['Contenidos'],
            ),
          ),
        ),
        FFRoute(
